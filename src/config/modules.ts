    ...
    },
    {
      ...
      fields: [
        { key: 'google_ads_access_help', type: 'info',
          content: '**Add contact@sereniumai.com as Admin in Google Ads.**\n\n[→ Official guide for Google Ads](https://support.google.com/google-ads/answer/6372672?hl=en)',
        },
...
*"By submitting this form or engaging our services, you consent to communications from us and our authorized agents (including AI-assisted SMS, email, and phone) in accordance with Canada's Anti-Spam Legislation (CASL). You may withdraw consent at any time by replying STOP to any message."*`,
    ...
    },
    {
      ...
      lockedMessage: "**We'll set you up with an account on our CRM first, then unlock this section.** Once your access is live, the two short guides below will walk you through linking your calendar and setting availability in about 10 minutes.",
      ...
      fields: [
        ...
        { key: 'calendar_connected', label: "I've connected my calendar to my CRM account", type: 'checkbox', required: true, tooltip: 'Tick once you have linked your calendar inside the CRM account we provided. This is the handshake that lets the AI drop appointments straight onto your calendar without double-booking.' },
        ...
        { key: 'availability_set_in_ghl', label: "I've set my booking availability inside the CRM", type: 'checkbox', required: true, tooltip: 'Set your weekly hours and any breaks inside the CRM so the AI never books during them. Single source of truth, no need to repeat yourself.' },
      ],
    },
  ],
};
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'crm_choice', label: 'CRM', type: 'select', required: true,
          options: ['Serenium CRM (managed by us)', 'HubSpot', 'Salesforce', 'Pipedrive', 'Zoho', 'JobNimbus', 'AccuLynx', 'Roofr', 'Other'],
          conditional: { field: 'submission_destination', op: 'includes', value: 'CRM' },
          tooltip: 'Which CRM should receive new leads. If you do not have one, "Serenium CRM (managed by us)" is included and integrates cleanly with the AI SMS and Receptionist services.',
        },
      ],
    },
    {
      ...
      fields: [
        ...
        { key: 'registrar', label: 'Your domain registrar', type: 'select', required: true, options: ['GoDaddy', 'Namecheap', 'Cloudflare', 'Other'], tooltip: 'Where the domain itself is registered. Pick yours and the matching guide will appear below.' },

        { key: 'registrar_help_godaddy', type: 'info',
          conditional: { field: 'registrar', op: 'eq', value: 'GoDaddy' },
          content: "**Invite contact@sereniumai.com as a delegate on your GoDaddy account.**\n\n[→ Official guide for GoDaddy](https://www.godaddy.com/en-ca/help/invite-a-delegate-to-access-my-godaddy-account-12376)",
        },
        { key: 'registrar_help_namecheap', type: 'info',
          conditional: { field: 'registrar', op: 'eq', value: 'Namecheap' },
          content: "**Share access to your domain with contact@sereniumai.com in Namecheap.**\n\n[→ Official guide for Namecheap](https://www.namecheap.com/support/knowledgebase/article.aspx/192/46/how-do-i-share-access-to-my-domain-with-other-users/)",
        },
        { key: 'registrar_help_cloudflare', type: 'info',
          conditional: { field: 'registrar', op: 'eq', value: 'Cloudflare' },
          content: "**Add contact@sereniumai.com as a member in Cloudflare with Super Administrator role.**\n\n[→ Official guide for Cloudflare](https://developers.cloudflare.com/fundamentals/manage-members/manage/)",
        },
        { key: 'registrar_help_other', type: 'info',
          conditional: { field: 'registrar', op: 'eq', value: 'Other' },
          content: "**Add contact@sereniumai.com to your registrar with admin / DNS-edit permission.**\n\nLog in, find **Account Settings → User Management** (or similar). Wording varies by registrar (delegate, user, member, partner) but the access we need is the same.",
        },

        { key: 'registrar_access_granted', label: "I've added contact@sereniumai.com on my registrar with DNS-edit permission", type: 'checkbox', required: true, tooltip: 'Tick once you have added us. We never transfer the domain, you stay the owner. We just need temporary access to point it at the new site on go-live day.' },
      ],
    },
    {
      key: 'existing_site',
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'ga_help_yes', type: 'info',
          ...
          content: "**Add contact@sereniumai.com as Administrator in Google Analytics.**\n\n[→ Official guide for Google Analytics](https://support.google.com/analytics/answer/9305788?hl=en#Add)",
        },
        ...
        { key: 'gsc_help_yes', type: 'info',
          ...
          content: "**Add contact@sereniumai.com as Full User in Google Search Console.**\n\n[→ Official guide for Google Search Console](https://support.google.com/webmasters/answer/7687615)",
        },
        ...
        { key: 'gtm_help_yes', type: 'info',
          ...
          content: "**Add contact@sereniumai.com as Administrator in Google Tag Manager.**\n\n[→ Official guide for Google Tag Manager](https://support.google.com/tagmanager/answer/6107011?hl=en)",
        },
