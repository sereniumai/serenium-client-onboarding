  ...
  modules: [
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'emergency_phone', label: 'Emergency contact phone (if different from main)', type: 'phone', conditional: { field: 'emergency_offered', op: 'eq', value: 'Yes' }, placeholder: '403-555-0199', tooltip: 'Only if emergencies should ring a different phone than your main line (e.g. owner cell at night). Leave blank to use the main number.' },
    ...
    },
    {
      ...
      estimatedMinutes: 1,
      fields: [{ key: 'year_founded', label: 'Year the business was founded', type: 'number', placeholder: 'e.g. 2012', helpText: 'We display this as "Est. 2012" so it stays accurate without needing updates each year.', tooltip: 'The year you actually started taking jobs. Used as "Est. 2012" branding wherever your business shows up, plus answering "how long have you been around?".' }],
    },
    {
      key: 'tagline',
...
*"By submitting this form or engaging our services, you consent to communications from us and our authorized agents (including AI-assisted SMS, email, and phone) in accordance with Canada's Anti-Spam Legislation (CASL). You may withdraw consent at any time by replying STOP to any message."*`,
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          tooltip: 'Tick everything you want the AI to confirm before it books. The same list shows up in your booking notification email, so pick what you actually want to see before you arrive on site. Recommended max 5 to keep the conversation human.',
        },
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'availability_set_in_ghl', label: 'I\'ve set my booking availability inside GoHighLevel', type: 'checkbox', required: true, helpText: 'Set your weekly hours, lunch break, and time off directly in GHL so it\'s the single source of truth. [Step-by-step guide →](https://help.gohighlevel.com/support/solutions/articles/155000001716-calendar-availability-weekly-working-hours-date-specific-hours)', tooltip: 'Set your weekly hours and any breaks (e.g. lunch) inside GHL so the AI never books during them. We keep it in GHL rather than asking you twice, that way changes you make later flow through automatically.' },
      ],
    },
  ],
};
  ...
  modules: [
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'additional_emails', label: 'Additional recipients (email)', type: 'repeatable', tooltip: 'Extra inboxes to copy on every summary (sales rep, office manager, etc.). All recipients get the same email at the same time.' },
        {
          ...
          helpText: 'Recommended max 5 — anything more makes the call feel like an interrogation.',
          tooltip: 'Tick everything you want the AI to confirm and include in the summary email. The AI will work each item into the question flow naturally instead of reading them like a checklist. Recommended max 5.',
        },
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'retell_emergency_phone', label: 'Phone number to reach for emergencies', type: 'phone', required: true, conditional: { field: 'retell_emergency_enabled', op: 'eq', value: 'Yes' }, placeholder: '403-555-0199', tooltip: 'The number the AI rings the moment it detects an emergency. Owner cell at night is the most common pick.' },
        { key: 'retell_emergency_route_to', label: 'Who should the call go to?', type: 'text', required: true, conditional: { field: 'retell_emergency_enabled', op: 'eq', value: 'Yes' }, placeholder: 'e.g. Rob (owner), or "any available crew lead"', tooltip: 'Name or role of the person who answers emergency calls. We use this in the AI summary so whoever picks up knows the context instantly.' },
      ],
    },
    {
  ...
  modules: [
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'registrar', label: 'Your domain registrar', type: 'select', required: true, options: ['GoDaddy', 'Namecheap', 'Cloudflare', 'Other'], tooltip: 'Where the domain itself is registered. Pick yours and we will show a walkthrough below for that exact registrar.' },
        { key: 'other_registrar_info', type: 'info',
          conditional: { field: 'registrar', op: 'eq', value: 'Other' },
          content: "Log into your registrar. Find **Account Settings / User Management / Delegate Access**. Add `contact@sereniumai.com` with admin or DNS-edit permissions." },
      ...
      conditionalLinks: {
        GoDaddy: 'https://www.godaddy.com/en-ca/help/invite-a-delegate-to-access-my-godaddy-account-12376',
