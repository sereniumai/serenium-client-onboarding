...
const BUSINESS_PROFILE: ServiceDef = {
  ...
  modules: [
    ...
    },
    {
      ...
      estimatedMinutes: 10,
      fields: [
        { key: 'team_members', label: 'Team members', type: 'repeatable', placeholder: 'Name | Role | One-line bio', helpText: 'One person per row, formatted: **Name | Role | One-line bio**. Click "Add another" for each new team member.', tooltip: 'Add owners and key crew. Real names and a one-line bio per person turn "some roofer" into people a homeowner can picture in their driveway, which lifts trust and conversion.' },
        { key: 'team_imagery_link', label: 'Team imagery link (Drive / Dropbox)', type: 'url', placeholder: 'https://drive.google.com/…', helpText: 'A folder of headshots or candid team photos. Make sure the link is set to "anyone with the link can view".', tooltip: 'Make sure file names match the team member names above so we can match them up correctly.' },
      ],
    },
    {
      key: 'social_profiles',
  ...
  modules: [
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'current_website_url', label: 'Current website URL', type: 'url', required: true, placeholder: 'https://yourcompany.ca', conditional: { field: 'has_live_website', op: 'eq', value: 'Yes' }, tooltip: 'The exact live URL of your current site (with https://). We use this to set up 301 redirects from old pages to new ones.' },
