    ...
    <tr><td align="center">
      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;background:#111;border:1px solid rgba(255,255,255,0.08);border-radius:16px;padding:40px 32px;">
        <tr><td>
          ...
          <p style="margin:0 0 14px;color:rgba(255,255,255,0.78);font-size:15px;">A quick tip — open this on a desktop or laptop and block out 30–45 minutes when you can give it your full attention. The answers you give shape everything we build for you, so it's worth doing properly.</p>
