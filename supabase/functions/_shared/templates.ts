...
export function invitationEmail({
  ...
  const html = shell(`
    ...
    <p style="color: ${muted}; line-height: 1.6; margin: 0 0 12px;">It's where you'll fill in everything we need to launch ${businessName}'s online presence, your AI receptionist, your ads, your site, and your reputation. Log in any time, save as you go, pick up exactly where you left off.</p>
